...
public class MongoCatalogService implements CatalogService {
    ...
    static {
        ...
        DEFAULT_PRODUCT_LIST.add(new Product("444434", "Lync (Skype)", "Standard: Categorized as 'Instant Messaging – Standard' in Service Catalogue. Provides person-to-person instant messaging, audio\video calls and file transfer. Does NOT include Desktop\Application sharing or conferencing features.", 0.00));
        DEFAULT_PRODUCT_LIST.add(new Product("444435", "Microsoft Project Professional 2016", "Microsoft Project can be used to assign resources, lay out plans, track phases of projects, analyze workloads, and control budgets. It is useful for managing the progress of small and large projects.Capital Markets US Firm ("Firm") issued mobile devices ("Mobile Devices") are intended for employees who require mobile access to carry out company business on behalf of the Firm.", 0.00));
