...
public class MongoCatalogService implements CatalogService {
    ...
    static {
        ...
        DEFAULT_PRODUCT_LIST.add(new Product("444434", "Lync (Skype)", "Provides person-to-person instant messaging, audio-video calls and file transfer. Does NOT include Desktop-Application sharing or conferencing features.", 0.00));
